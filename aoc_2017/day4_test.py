...
MY_INPUT = test_utils.get_path(__file__, "day4_real.csv")
...
class Day4Test(unittest.TestCase):
    ...
    def test_day4_1(self):
        self.assertEqual(day4.day4_1(test_utils.get_path(__file__, "day4_1_example.csv")), 1)
        self.assertEqual(day4.day4_1(MY_INPUT), 383)

    def test_day4_2(self):
        self.assertEqual(day4.day4_2(test_utils.get_path(__file__, "day4_2_example.csv")), 3)
